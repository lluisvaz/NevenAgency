  ...
  return (
    <div className="relative w-full bg-black text-white font-sans min-h-screen">
      ...
      <section className="relative min-h-screen w-full overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-20 w-full max-w-[1920px] mx-auto px-6 md:px-12 lg:px-24 xl:px-48 pt-48 md:pt-48 lg:pt-56 pb-20 flex flex-col items-center text-center">
          <div className="max-w-4xl flex flex-col items-center">
            ...
            <div className="space-y-4 mb-8 md:mb-12 flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-8 mb-12 md:mb-20">
              <button className="w-full sm:w-auto bg-white text-black px-10 py-4 font-bold uppercase tracking-wide text-sm md:text-base hover:bg-primary hover:text-white transition-colors cursor-pointer rounded-none">
                Get Started Now
              </button>
              <a
                href="#"
                className="group flex items-center gap-3 bg-white/[0.02] backdrop-blur-md border border-white/10 px-8 py-4 font-bold uppercase tracking-wide text-sm md:text-base hover:bg-white/10 transition-all duration-300 cursor-pointer rounded-none"
              >
