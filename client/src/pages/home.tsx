    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-white text-black font-sans">
      ...
      <main className="relative z-20 container-fluid px-4 md:px-12 pt-16 md:pt-32 lg:pt-48 pb-20">
        <div className="max-w-3xl">
          ...
          <h1 className="text-[clamp(2.5rem,15vw,4.5rem)] md:text-7xl lg:text-8xl font-heading font-bold uppercase leading-[0.9] mb-6 md:mb-10 text-black tracking-tight break-words">
            Championing<br />
            Hometown Heroes
          </h1>
