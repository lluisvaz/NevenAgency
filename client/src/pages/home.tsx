...
export default function Home() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-white text-black font-sans">
      ...
      {/* Hero Content */}
      <main className="relative z-20 container-fluid px-8 md:px-32 lg:px-48 pt-16 md:pt-32 lg:pt-48 pb-20">
        <div className="max-w-3xl">
          <h2 className="text-gray-600 font-bold tracking-widest text-sm mb-4 uppercase">
            Home Services Marketing Agency
          </h2>
          
          <h1 className="text-[clamp(2.2rem,13vw,4.2rem)] md:text-6xl lg:text-7xl font-heading font-bold uppercase leading-[0.9] mb-6 md:mb-10 text-black tracking-tight break-words">
            Championing<br />
            Hometown Heroes
          </h1>
