    ...
    <div className="relative w-full overflow-x-hidden bg-white text-black font-sans">
      ...
      <section className="relative min-h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-white/90 via-white/40 to-transparent z-10 hidden md:block" />
          <div className="absolute inset-0 bg-gradient-to-r from-white/90 via-white/60 to-transparent z-10 md:hidden" />
